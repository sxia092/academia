...
REPEAT: MOV R0, _num_12D                ; Size of 'Missouri S&T'
        MOV DPTR, #STRING
        ACALL BLINK

LOOP:   MOV P1, _num_0H                 ; P1 = output port
        CLR A
        MOVC A, @A+DPTR
        MOV P1, A                   ; P1 = string
        INC DPTR                    ; DPTR++
...
DELAY:  MOV R7, _num_118D               ; 256 / 1.085 = 235.9269 * 1/2 (djnz) = 118
HERE:   DJNZ R7, HERE
        RET

BLINK:  MOV P0, _num_0H                 ; Make output port
        CLR P0.1                    ; Low
        SETB P0.1                   ; To High
        CLR P0.1                    ; To low
        RET
...
\begin{verbatim}
        ...
        */
        ...
        MOV P1, _num_0FFH               ; P1 = Input Port
        MOV P2, _num_0H                 ; P2 = Output Port
        MOV P1, _num_32H

REPEAT: MOV R0, _num_3D                 ; Number to read in
        MOV R1, _num_100D
        MOV R2, _num_0D
...
LOOP:   MOV A, P1
        ANL A, _num_0FH                 ; By and-ing with 0F, upper bits are cleared.
...
DELAY1: MOV R7, _num_118D               ; 256 / 1.085 = 235.9269 * 1/2 (djnz) = 118
HERE1:  DJNZ R7, HERE1
        RET


DELAY2: MOV R6, _num_4D
...
ADDV:   MOV R0, _num_30H                ; Where values are stored
        MOV R1, _num_9D                 ; Size of 'MYDATA'
        CLR A
LOOP2:  ADD A, @R0
        INC R0
...
AVG:    MOV R0, _num_30H                ; Where values are stored
        MOV R1, _num_0D                 ; Counter
        MOV R2, _num_0D                 ; Sum
...
\begin{verbatim}
        ...
        */
        ...
        CLR C                       ; CY = 0
        CJNE R0, _num_4D, NEXT
NEXT:   JC SKIP                     ; if CY = 0, outside of range (by CJNE)
        MOV P2, _num_0H                 ; R2 = 0, if outside of 0 <= x <= 3
        ACALL DONE                  ; Finish
