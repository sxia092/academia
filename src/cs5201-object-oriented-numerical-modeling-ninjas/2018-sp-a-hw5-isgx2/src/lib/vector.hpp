...
/**
 *  @brief  Determine if two vectors are the same.
 *
 *  @param  leftHandSide The first vector to compare to.
 *  @param  rightHandSide The second vector to compare to.
 *
...
/**
 *  @brief  Determine if two vectors are not the same.
 *
 *  @param  leftHandSide The first vector to compare to.
 *  @param  rightHandSide The second vector to compare to.
 *
...
/**
 *  @brief  Multiply two vectors, follow by assigning one to another.
 *
 ...
 **/
template <typename T>
void operator*=(Vector<T>& leftHandSide, const Vector<T>& rightHandSide) {
    leftHandSide = std::move(leftHandSide * rightHandSide);
}

/**
 *  @brief  Add two vectors, follow by assigning one to another.
 *
 *  @param  leftHandSide The left hand side of the equation, the `Vector` to assign to.
 *  @param  rightHandSide The right hand side of the equation.
 *
 ...
 **/
template <typename T>
void operator*=(Vector<T>& vector, const T& scalar) {
    auto size = vector.size();
