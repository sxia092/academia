...
# Instructions: To run this file, type 'python3 client.py <hostname>' in the commandline #
# Extra Info: The server will print out the hostname for the client to use when the      #
#             server is started.                                                         #
##########################################################################################
