...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=.75\linewidth]{assets/problem_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.75\linewidth]{assets/problem_4.png}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=.75\linewidth]{assets/problem_6.png}
    \framebox[.75\linewidth]{\rule{0pt}{3cm}Missing: assets/problem-6.png}
    \caption{Weka output for problem 6}
