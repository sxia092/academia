...
\nobreak\extramarks{_num_1}{_num_1 continued on next page\ldots}\nobreak
\nobreak\extramarks{_num_1 (continued)}{_num_1 continued on next page\ldots}\nobreak
}

% Header and footer for when a page split occurs between problem environments
\newcommand{\exitProblemHeader}[1]{
\nobreak\extramarks{_num_1 (continued)}{_num_1 continued on next page\ldots}\nobreak
\nobreak\extramarks{_num_1}{}\nobreak
}
...
\renewcommand{\homeworkProblemName}{_num_1} % Assign \homeworkProblemName the name of the problem
...
\begin{tcolorbox}[colback=black!5!white,colframe=black!75!black]
    \centering
    \begin{minipage}{0.98\columnwidth}_num_1\end{minipage}
\end{tcolorbox} % Makes the box around the problem answer and puts the content inside
}

\newcommand{\homeworkSectionName}{}
\newenvironment{homeworkSection}[1]{ % New environment for sections within homework problems, takes 1 argument - the name of the section
\renewcommand{\homeworkSectionName}{_num_1} % Assign \homeworkSectionName to the name of the section from the environment argument
...
\newcommand{\hmwkTitle}{Test \_num_1} % Assignment title
