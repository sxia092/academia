...
\input{macros}
\usepackage{multicol}
% \usepackage[shortlabels]{enumerate} % Removed - enumitem loaded in macros
...
Method \_num_1 is the most accurate, because the true positive ($y$-axis) correctly identified the values, while the false positive ($x$-axis) incorrectly identified the values. Method \_num_1 had the fastest growing function (with respect to $y$).
