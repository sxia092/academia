    ...
    \end{itemize}
     \subsection{Processing}
      \begin{itemize}       
       ...
       \item \textbf{SMP}: Symmetric MultiProcessing, multiple, connected, homogeneous processors using shared memory.
      ...
      \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{Unix Thread Synchronization Primitives}: Mutual exclusion (mutex) locks:
        \begin{itemize}
          ...
          \end{itemize}
           ...
           \end{itemize}
            ...
            \item If there is a single sequence available in which it can complete without deadlock (all P require more V than is free),
                  the state is \textbf{safe}. Without it, there's a possibility it may occur (waiting on another process to free memory).
