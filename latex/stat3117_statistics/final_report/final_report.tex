...
\usepackage{amssymb,amsmath,verbatim,graphicx,microtype,upquote,units,booktabs,siunitx,xcolor,multicol,pdfpages,float,array,wrapfig,subcaption}
...
\begin{figure}[t!]
    \begin{subfigure}[t]{0.45\textwidth}
        \begin{center}
            \includegraphics[width=\textwidth]{actual_by_predicted_plot.png}
        \end{center}
...
% \begin{multicols}{2}
%     \centering
%     % \frame{\includegraphics[width=.45\textwidth,page=1]{results.pdf}} % File not found
%     % \frame{\includegraphics[width=.45\textwidth,page=2]{results.pdf}} % File not found
% \end{multicols}
