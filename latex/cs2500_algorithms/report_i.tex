...
\begin{eqnarray}
    \text{Subset \_num_0}: 0_{10} = 000_{2} = \sim(ABC) & = & \text{No Items} \\
    \text{Subset \_num_5}: 5_{10} = 101_{2} = A\sim(B)C & = & \text{Items A, B} \\
    \text{Subset \_num_7}: 7_{10} = 111_{2} = ABC & = & \text{Items A, B, C}
\end{eqnarray}
