...
\newcommand{\todo}[1]{\textbf{\colorbox{red!50}{_num_1}}}
...
\begin{figure}[!ht]
    % \includegraphics[width=\textwidth]{assets/space_invaders.jpg}
    \framebox[\textwidth]{\rule{0pt}{3cm}Missing: assets/space-invaders.jpg}
...
\begin{figure}[!ht]
    ...
    \framebox[\textwidth]{\rule{0pt}{3cm}Missing: assets/game.png}
...
\begin{figure}[!ht]
    ...
    \framebox[.5\textwidth]{\rule{0pt}{3cm}Missing: assets/menu}
...
\begin{figure}[!ht]
    ...
    \framebox[\textwidth]{\rule{0pt}{3cm}Missing: assets/schematic}
