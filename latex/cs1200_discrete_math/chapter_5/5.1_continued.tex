...
\textbf{Problem}: Prove by mathematical induction that $\forall n \in \mathbb{Z}^+ \cup \{0\}, 6 | 7^n - 1$

\textbf{Solution}: Proof [*By Mathematical Induction*].
Let the predicate $P(k)$ be the statement $6 | 7^n - 1$. We will prove that $P(n)$ is true $\forall n \in \mathbb{Z}^+ \cup \{0\}$.

\textit{Basis Step}: Show that $P(0)$ is true. $P(0)$ is true because $6 | 7^0 -1 = 6 | 1-1 = 6 | 0$

\textit{Inductive Step}: Show that $\forall n \in \mathbb{Z}^+ \cup \{0\}, P(k) \rightarrow P(k + 1) $.
Let $k \in \mathbb{Z}^+ \cup \{0\}$ and suppose that $6 | 7^k - 1$ (inductive hypothesis.)
Show that $6 | 7^{k+1} - 1$.
...
Now $7^k + r \in \mathbb{Z}$ because the products and sums of integers are integers. Thus by divisibility, $6 | 7^{k + 1} - 1$. $\square$

\textbf{Problem}: A sequence $d_1, d_2, d_3$ is defined by letting $d_1 = 2 \text{ or } \forall k \in \mathbb{Z}, k ≥ 2. d_k = \frac{d_k - 1}{k}$ Prove that $\forall n \in \mathbb{Z}^+, d_n = \frac{2}{n!}$

\textbf{Solution}: Proof (By mathematical induction)
According to the definition of  $d_1, d_2, d_3, \cdots,$ we have  $d_1 = 2 \text{ or } \forall k \in \mathbb{Z}, k ≥ 2, d_k \frac{d_k - 1}{k} $.
...
\textit{Inductive Step}: Show $\forall k \in \mathbb{Z}^+, P(k) \rightarrow P(k + 1).$
...
\textit{Inductive Step}: Show that $\forall k \in \mathbb{Z}, k ≥ 2, P(k) \rightarrow P(k + 1)$.
