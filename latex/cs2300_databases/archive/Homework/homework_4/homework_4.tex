...
\begin{enumerate}
    ...
    \begin{itemize}
        \item No, because in the functional dependency $C \rightarrow D$, $D$ is not a part of any candidate key and $C$ is not a superkey.
    ...
    \begin{itemize}
        \item Yes, because $ACE$ is a superkey and $C$ is part of the candidate key.
