...
\br
\textsc{Steps} & \begin{enumerate}[topsep=0pt]
\item Check to see if input is valid. If it is, proceed. If not, display error message to the user.
...
\end{enumerate} \\
\br
\textsc{Output} & Either the search user will be projected or an error message if the user does not exist. \\
\br
