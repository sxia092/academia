...
Assuming Problem \_num_1 is correct,

\begin{verbatim}
        ORG 0H

        MOV R0, _num_100D
LOOP:   MOV TMOD, _num_01D
        MOV TH0, #EEH
        MOV TL0, _num_00H   ; (FFFF - EE00 + 1)*1.085 = 5ms
        ACALL DELAY
...
LOOP:   MOV TMOD, _num_01D
        MOV TH0, _num_0D    ; lowest frequency => highest period
        MOV TL0, _num_0D    ; highest period => Smallest TH, TL
        SETB P1.3
        ACALL DELAY
