...
Bitboard ChessEngine::northMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    auto result = board;
...
Bitboard ChessEngine::southMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    auto result = board;
...
Bitboard ChessEngine::eastMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
...
Bitboard ChessEngine::westMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
...
Bitboard ChessEngine::northeastMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    const static Bitboard aFileInverse = 0xfefefefefefefefe;
...
Bitboard ChessEngine::northwestMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    const static Bitboard hFileInverse = 0x7f7f7f7f7f7f7f7f;
...
Bitboard ChessEngine::southeastMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    const static Bitboard aFileInverse = 0xfefefefefefefefe;
...
Bitboard ChessEngine::southwestMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    const static Bitboard hFileInverse = 0x7f7f7f7f7f7f7f7f;
...
Bitboard ChessEngine::pawnNorthMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    auto result = board;
...
Bitboard ChessEngine::pawnSouthMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    auto result = board;
...
Bitboard ChessEngine::pawnSouthSouthMovesWithBlockers(Bitboard board, const Bitboard& blockerInverse) {
    auto result = board;
...
std::vector<std::pair<char, int>> ChessEngine::bitStringToDescription(Bitboard board) {
...
int ChessEngine::pieceToInt(const Piece piece) {
    // Just a rapper for a static cast
    return static_cast<int>(piece);
}

Piece ChessEngine::intToPiece(const int integer) {
    // Just a rapper for a static cast
    return static_cast<Piece>(integer);
}

void ChessEngine::generateInitialState(std::vector<Bitboard>& white, std::vector<Bitboard>& black) {
...
Bitboard ChessEngine::allBitboardsInOneBoard(const std::vector<Bitboard> boards) {
...
Bitboard ChessEngine::moving(const Bitboard& board, const Direction& direction) {
...
Bitboard ChessEngine::kingMoves(const Bitboard& king, const Bitboard& self) {
...
Bitboard ChessEngine::knightMoves(const Bitboard& knight, const Bitboard& self) {
...
Bitboard ChessEngine::rookMoves(const Bitboard& rook, Bitboard self, Bitboard enemy) {
    self = ~self;
    enemy = ~enemy;
...
Bitboard ChessEngine::bishopMoves(const Bitboard& bishop, Bitboard self, Bitboard enemy) {
    self = ~self;
    enemy = ~enemy;
...
Bitboard ChessEngine::queenMoves(const Bitboard& queen, Bitboard self, Bitboard enemy) {
    self = ~self;
    enemy = ~enemy;
...
Bitboard ChessEngine::pawnMoves(const Bitboard& pawn, Bitboard self, Bitboard enemy, const Color& selfColor) {
...
Bitboard ChessEngine::castlingMoves(const Bitboard& castlingSquares, const Bitboard& allWhite, const Bitboard& allBlacks) {
...
Bitboard ChessEngine::enpassantMoves(const Bitboard& enemyEnpassantSquares, const Bitboard& selfPawns) {
