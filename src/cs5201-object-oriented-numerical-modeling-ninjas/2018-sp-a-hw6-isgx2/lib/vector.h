...
public:
    ...
    template <class S> friend S norm(const Vector<S>& leftHandSide);
    ...
    template <class S> friend S operator*(const Vector<S>& leftHandSide, const Vector<S>& rightHandSide);
    template <class S> friend Vector<S> operator+(const Vector<S>& leftHandSide, const Vector<S>& rightHandSide);
    template <class S> friend Vector<S> operator-(const Vector<S>& leftHandSide, const Vector<S>& rightHandSide);

    void operator*=(const T& scalar);
    void operator+=(const Vector<T>& rightHandSide);
    void operator-=(const Vector<T>& rightHandSide);
