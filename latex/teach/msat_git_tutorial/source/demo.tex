...
\begin{enumerate}
    ...
    \item Re-checkout the main branch via \shellcmd{git checkout main}. Merge with \shellcmd{git merge game}.
...
\begin{enumerate}
    ...
    \item Checkout the main branch (\shellcmd{git checkout main}) and merge \\ (\shellcmd{git merge bug-fixes}).
\end{enumerate}
