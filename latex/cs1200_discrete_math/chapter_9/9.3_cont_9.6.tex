...
\noindent
Out of 100 students, 28 checked \_num_1, 26 checked \_num_2, and 14 checked \_num_3, \_num_8 checked both \_num_1 and \_num_2, 4 checked \_num_1 and \_num_3, 3 checked \_num_2 and \_num_3, and 2 checked all three.
...
\begin{itemize}
    ...
    \item Let \textit{H} be the set of students who checked \_num_1, \textit{C} those who checked \_num_2, and \textit{D} those who checked \_num_3. \textit{Insert Picture}
    \item How many checked \_num_1 and \_num_2, but not \_num_3. $N(H \wedge C) - N(H \wedge C \wedge D) = \textbf{8 - 2 = 6}$
    \item How many checked \_num_2 and \_num_2, but not \_num_1. $N(C \wedge D) - N(C \wedge D \wedge H) = \textbf{3 - 2 = 1}$
    \item How many checked \_num_2, but neither of the others? $N(C) - N(C \wedge H) - N(C \wedge D) + N(C \wedge D) + N(C \wedge H \wedge D) = \textbf{26 - 8 - 3 + 2 = 17}$
\end{itemize}
