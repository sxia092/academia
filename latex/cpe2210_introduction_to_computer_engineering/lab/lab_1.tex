...
\newcommand{\todo}[2]{\textbf{\colorbox{red!50}{_num_1}}{\footnote{_num_2}}}
...
\usepackage{siunitx}
\begin{document}
\title{Lab \_num_1: Laboratory Equipment}
...
% \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{Graph}}
