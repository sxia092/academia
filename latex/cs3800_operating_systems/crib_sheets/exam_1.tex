...
\includegraphics[width=\columnwidth]{memory_hierachy}
...
\begin{description}
    ...
    % \item[Hit Ratio] in a two-level memory — the fraction of all memory accesses that are found in a the main memory (i.e. the cache)
