...
const char DNA_MEMBERS[NUMBER_OF_DNA_MEMBERS] = {'C','T','G','A'};
// MUST MATCH DECLARATION LENGTH
const float DNA_PERCENTAGES[NUMBER_OF_DNA_MEMBERS] = { .30, .20, .15, .35};
// MUST ADD UP TO 1.0
...
const int FINGERPRINT_SIZE =
LENGTH_OF_FINGERPRINT_ARRAY * HEIGHT_OF_FINGERPRINT_ARRAY;
// Simple and intuitive but useful.

const int NUMBER_OF_FINGERPRINT_MEMBERS = 2;
// Falls apart past two, keep that in mind.
...
const float HAIR_OFF_BY_THREE_OR_MORE = 0.0;
// I know this seems redundant, but..
// For some strange reason i feel like Price is going to change
// all of the constants at the last minute.. so i'm not taking any chances.


/*--------------------Judicial Class--------------------*/
// Illya Starikov created these consants.
// All punishment should be dealt to him.
const std::string DEFAULT_JUDGE = "Adam Bowers";
// The judge, the jury, and the executioner.
const int DEFAULT_CONVICTION_RATE = 95;
// Ironically, about the average on my homework.
