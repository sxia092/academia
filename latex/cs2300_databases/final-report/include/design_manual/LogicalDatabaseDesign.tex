...
\begin{adjustwidth}{-2.25cm}{}
    ...
    \begin{tabular}{l|lll}
        ...
        \textbf{DateStamp}        & \texttt{timestamp} & timestamp of creation & Timestamp of post creation.  \\
        ...
        \textbf{TimeStamp}        & \texttt{date}      & unique                & Date of users weight measurement.  \\ \midrule
