...
\usepackage{amssymb,amsmath,verbatim,graphicx,microtype,upquote,units,booktabs,siunitx,xcolor,textcomp,tikz,gantt,graphics,hyperref}
...
\newcommand{\task}[1]{%
    ...
    \subsubsection*{Task \#\thetasks: _num_1}
}
