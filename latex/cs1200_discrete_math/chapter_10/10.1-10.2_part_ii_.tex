...
\begin{eqnarray}
Total\ Edges & = & \frac{Add\ Them\ Up}{2} \\
& = & \frac{16}{2} \\
& = & 8
\end{eqnarray}
...
\textbf{THIS WILL PROBABLY BE ON EXAM}.
...
Find the adjacency matrix for: \textit{insert picture}

Column x rows, from x to:
...
Determine without drawing whether this graph is connected.
