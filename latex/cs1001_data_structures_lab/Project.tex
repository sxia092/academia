...
\begin{description}
    ...
    \item [Text folding (\keys{z}+\keys{f})] Text folding allows collapsing sections of text for better navigation.
\end{description}
...
\begin{enumerate}
    ...
    \item Waits until all previous processes have finished until continuing.
\end{enumerate}
