...
No, because if $F: X \rightarrow Y$ is not one-to-one, then $\exists (x_1, x_2) \in X \bigwedge \exists y \in Y, x_1 \neq x_2 \bigwedge (x_1,y) \in F \bigwedge (x_2,y) \in F$. But this implies $\exists x_1, x_2 \in X \bigwedge \exists y \in Y, x_1 \neq x_2 \bigwedge (y,x_1) \in F^{-1} \bigwedge (y, x_2) \in F^{-1}.$ Consequently, $F^{-1}$ does not satisfy property (2) of the definition of function. \\
...
\noindent R: $\{ (0,0), (0,1), (0,3), (1,0), (1,1), (2,2), (3,0), (3,3) \}$

\noindent S: $\{ (0,0), (0,2), (0,3), (2,3) \}$
