...
\begin{lstlisting}[style=cASM]
        ...
        /* Main */
        ORG 0030H
MAIN:   MOV P2, _num_00H        ; P2 = output port
        MOV TMOD, _num_20H      ; Timer 1, mode 2
...
\begin{lstlisting}[style=cASM]
        ...
        /* Main */
        ORG 30H
MAIN:   MOV TMOD, _num_12H          ; T0M2 & T1M1
        MOV P1, _num_0              ; P1 = output port
        ACALL WAVE0
        ACALL WAVE1
...
\begin{lstlisting}[style=cASM]
        ...
        ORG 30H
MAIN:   MOV R7, _num_1D
        MOV P1, _num_0              ; Make P1 an output port
        MOV IE, _num_88H            ; Enable interrupt on T1
...
SWAVE:  MOV TMOD, _num_20H  ; Timer 2, mode 2

        CJNE R6, _num_70, SKIP2LOW
        ACALL HWAVE
        SJMP NEXT
...
HWAVE:
        SETB P1.1
        MOV TH1, #-92
        MOV R6, _num_70             ; Just to keep track of what our last value was
        RET
