...
\begin{proof}
    \begin{description}
        \item[Step \_num_1] We wish to prove that for all natural numbers $f(n) = g(n)$, where $f$ and $g$ are as defined as follows:
        ...
        \item[Step \_num_2] Checking two values is trivial; take $2$ and $3$.
        ...
        \item[Step \_num_6]  Since Steps 1--5 have been verified, it follows from the Principle of Recursion that $P$ holds for all values in $\mathbb{Z^+}$, i.e., $f(n) = g(n), \forall n \in \mathbb{Z}^+$
    \end{description}
\end{proof}
