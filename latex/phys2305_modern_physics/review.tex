...
\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    \includegraphics[width=.45\textwidth]{photo_electric_effect}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.45\textwidth]{compton_scattering}
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    \includegraphics[width=.45\textwidth]{particle_in_a_box}
...
\begin{wrapfigure}{l}{0.5\textwidth}
    \centering
    \includegraphics[width=.45\textwidth]{energy_levels}
