...
\begin{figure}[!h]
    \centering
    \includegraphics[width=.90\columnwidth]{arduino_uno.jpg}
...
\begin{figure}[!ht]
    \centering
    % \includegraphics[width=.90\columnwidth]{pid_controller.pdf} % File not found
...
\begin{figure}[!ht]
    \centering
    % \includegraphics[width=.90\columnwidth]{hand_therapist.pdf} % File not found
