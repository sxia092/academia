...
% \input{../macros.tex} % File not found - commented out
\title{Final Cribsheet}

\usepackage{graphicx,forest,tikz-qtree,graphics,amsmath,amssymb,listings,amsthm,nicefrac}
\date{\today}
\let\oldemptyset\emptyset{}
\let\emptyset\varnothing{}
\newcommand{\cost}[1]{\text{cost}\left(_num_1\right)}
\newcommand{\bigO}[1]{O(_num_1)}
\newcommand{\bigTheta}[1]{\Theta(_num_1)}
\newcommand{\bigOmega}[1]{\Omega(_num_1)}
\newcommand{\ceil}[1]{\lceil _num_1 \rceil}
\newcommand{\floor}[1]{\lfloor _num_1 \rfloor}
\newcommand{\shellcmd}[1]{\texttt{_num_1}}
...
\includegraphics[width=\textwidth]{./assets/injective_etc.png}
...
\begin{itemize}
    ...
    \item As a result of Euler's Formula,
        \begin{itemize}
            ...
            \item A soccer ball must have exactly 12 pentagons
        \end{itemize}
...
\section{Main Theorem \& Fast Multiplication}
\begin{theorem}
