...
% Font warnings will be shown but won't cause errors
...
\newcommand{\presentby}[2]{%
    \note{%
        \topskip0pt
        \vspace*{\fill}
        \huge \textbf{_num_1, \textit{_num_2} Minute(s)}
        \vspace*{\fill}
    }
}

\newcommand{\presentaddcount}[1]{\addtocounter{_num_1}{1}\Roman{_num_1}}
\newcommand{\presentcount}[1]{\Roman{_num_1}}
