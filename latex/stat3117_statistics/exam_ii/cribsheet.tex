...
\newcommand*\xoverline[2][0.75]{%
    \sbox{\myboxA}{$\m@th_num_2$}%
    \setbox\myboxB\null% Phantom box
    \ht\myboxB=\ht\myboxA%
    \dp\myboxB=\dp\myboxA%
    \wd\myboxB=_num_1\wd\myboxA% Scale phantom
...
\begin{multicols}{3}
    ...
    \includegraphics[width=\columnwidth]{steps_for_verification}
    ...
    \includegraphics[width=\columnwidth]{factorial_expirement}
