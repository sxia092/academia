...
\begin{enumerate}
    \item Main Theorem (\textit{Case \#3}), $T(n) \in \bigTheta{n^4}$
    \item Main Theorem (\textit{Case \#3}), $T(n) \in \bigTheta{n}$
    \item Main Theorem (\textit{Case \#2}), $T(n) \in \bigTheta{n^2 \lg n}$
    \item Main Theorem (\textit{Case \#3}), $T(n) \in \bigTheta{n^2}$
    \item Main Theorem (\textit{Case \#1}), $T(n) \in \bigTheta{n^{\log _2 7}}$
    \item Main Theorem (\textit{Case \#2}), $T(n) \in \bigTheta{\sqrt{n} \lg n}$
...
\problem{}
\begin{enumerate}
    \item Main Theorem (\textit{Case \#1}), $T(n) \in \bigTheta{n^{\log_3 4}}$
    ...
    \item Main Theorem (\textit{Case \#3}), $T(n) \in \bigTheta{n^{2.5}}$.
    \item We augment the equation to be $3T(n/3) + n/2$, where we can use Main Theorem (\textit{Case \#2}), $T(n) \in \bigTheta{n \lg n}$.
