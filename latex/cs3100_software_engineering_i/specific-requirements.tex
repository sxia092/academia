...
The Camelot server will be run on a Raspberry Pi 3 Model B. It will need to have internet access. The hardware will need to have \gls{python}3 installed as well as \gls{postgres} for database management.
