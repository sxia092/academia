  ...
  \section{Multiprocessing}
    \subsection{Issues}
      \begin{itemize}
        ...
        \item When a single queue is used, a single process can be schedule to run on any processor (main node needed).
  ...
  \section{QA Pool}
    \subsection{Memory Management}
      \begin{itemize}
        ...
        \item \textbf{Hit-ratio}: in 2 level memory system (RAM-HD/cache-RAM), it is the frac of mem accesses found in main (first).
