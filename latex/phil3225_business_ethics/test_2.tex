...
\begin{homeworkProblem}[Problem \Roman{homeworkProblemCounter}] % Roman numerals
    ...
    \begin{figure}[!h]
        ...
        \begin{subfigure}{.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/1_left}
        ...
        \begin{subfigure}{.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/1_right}
    ...
    \begin{figure}[!h]
        ...
        \begin{subfigure}{.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/2_left}
        ...
        \begin{subfigure}{.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/2_right}
